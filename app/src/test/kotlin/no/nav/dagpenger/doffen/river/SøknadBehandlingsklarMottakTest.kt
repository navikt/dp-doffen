...
import no.nav.dagpenger.doffen.domene.TypeId.SAKID
import org.junit.jupiter.api.Test

class SøknadBehandlingsklarMottakTest {
    ...
    fun `mottar søknad melding`() {
        ...
        val json = javaClass.getResource("/meldinger/søknadBehandlingsklar.json")!!.readText()
        ...
        treCapture.captured.let {
            ...
            it.grupper.first().let { gruppe ->
                gruppe.id shouldBe "04909296396"
                gruppe.type.name shouldBe "SAK"
